...
/**
 * Traduzido 1:1 de StatusBadge.dc.html. Cinco tons semânticos, cada um com
 * cor de fundo/texto/borda e um ícone próprio — nunca depende só da cor
 * (requisito de acessibilidade do prompt de design).
 */
 ...
 * para não reimplementar cor por feature (regra do prompt de frontend).
 * Ajuste os rótulos (`label`) se preferir outro texto de exibição.
 */
export const STATUS_RECEBIVEL_TONE: Record<string, { label: string; tone: StatusTone }> = {
  PENDENTE: { label: 'Pendente', tone: 'neutral' },
  NEGOCIADO: { label: 'Negociado', tone: 'info' },
